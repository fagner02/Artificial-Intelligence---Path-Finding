...
para cada entrada, em uma nova linha:
    ...
    1 inteiro representando o id da função de heurística(-1 a 2, sendo -1 a ausência de heurística)
...
com a implementação das funções declaradas no .h. Na main.cpp só tem a implementação da interface.